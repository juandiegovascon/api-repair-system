...
echo "🚀 Configurando Repair System API con Conda en Windows..."
echo "=========================================================="
...
# En Windows, usar conda directamente sin source
...
if [ $? -ne 0 ]; then
    ...
    echo ""
    echo "🔧 Si continúa el error, ejecuta estos comandos manualmente:"
